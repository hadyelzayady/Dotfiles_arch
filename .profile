...
export PATH="$PATH:$HOME/.local/bin/scripts:$HOME/.local/bin:$HOME/.local/bin/statusbar:$GEM_HOME/bin:$HOME/go/bin"
...
export MSBuildSDKsPath="/opt/dotnet/sdk/5.0.201/Sdks/";
